...
const Home: React.FC = () => {
  ...
  useEffect(() => {
    ...
    if (savedHistory) {
      ...
      //Dispatch city to rebuild history
  ...
  return (
    <div className={`relative h-screen flex flex-col ${isDarkMode ? 'bg-gradient-to-br from-gray-900 via-gray-800 to-black' : 'bg-gradient-to-br from-blue-100 via-blue-300 to-indigo-200'} transition-colors duration-300 font-poppins`}>
      <div className="absolute inset-0 z-0">
        <svg className="w-full h-64 sm:h-80 md:h-full animate-slide-in opacity-20" viewBox="0 0 1440 320" xmlns="http://www.w3.org/2000/svg">
          <path
      ...
      <div className="relative z-20">
        <img
          ...
          className="absolute top-4 sm:top-6 md:top-8 right-5 sm:right-6 md:right-20 bottom-auto sm:bottom-5 md:bottom-20 w-16 sm:w-20 md:w-24 lg:w-28 rounded-full shadow-lg transform transition-all duration-300 hover:scale-110"
        />
      </div>
      <div className="relative z-10 text-center mt-2 text-black dark:text-white text-sm sm:text-base md:text-lg drop-shadow-lg font-bold">
      ...
      <div className="relative z-10 flex flex-col items-center justify-center pt-16 sm:pt-20 md:pt-24 pb-6 sm:pb-8 md:pb-10">
        <div className="flex flex-col md:flex-row items-center justify-center gap-4 md:gap-8 w-full max-w-6xl mx-auto">
          <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-extrabold text-center dark:text-white bg-gradient-to-r from-blue-600 to-indigo-600 bg-clip-text text-transparent animate-typewriter max-w-[90%] sm:max-w-2xl md:max-w-3xl lg:max-w-4xl xl:max-w-5xl mx-auto drop-shadow-lg">
            {headlines[currentHeadline]}
          </h1>
        </div>
        <p className="font-semibold mt-3 sm:mt-4 !text-2xl sm:text-lg md:text-xl !text-white dark:text-white animate-fade-in max-w-[90%] sm:max-w-lg mx-auto drop-shadow-lg">
      ...
      <div className="relative z-10 flex-1 flex items-center justify-center p-4 sm:p-6 md:p-8 min-h-0">
        <div className="w-full max-w-2xl bg-white/90 dark:bg-gray-800/90 backdrop-blur-lg rounded-3xl shadow-2xl p-6 sm:p-8 transform transition-all duration-500 hover:shadow-xl">
          <div className="flex flex-col sm:flex-row justify-between items-center mb-6 gap-4">
            <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 dark:text-white">Weather App</h2>
            <button
          ...
          <div className="relative group z-10">
            <div className="absolute -inset-1 bg-gradient-to-r from-blue-500 to-indigo-500 rounded-lg blur opacity-25 group-hover:opacity-50 transition duration-300 pointer-events-none"></div>
            <SearchBar />
          </div>
      ...
      <div className="relative z-10 text-center py-3">
        ...
        <div className="flex justify-center gap-4">
          <a href="https://twitter.com" target="_blank" rel="noopener noreferrer" className="text-gray-600 dark:text-gray-300 hover:text-blue-500 dark:hover:text-blue-400 transition-colors duration-200">
          ...
          <a href="https://facebook.com" target="_blank" rel="noopener noreferrer" className="text-gray-600 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-500 transition-colors duration-200">
            <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
          ...
          <a href="https://www.linkedin.com/in/orka" target="_blank" rel="noopener noreferrer" className="text-gray-600 dark:text-gray-300 hover:text-blue-700 dark:hover:text-blue-600 transition-colors duration-200">
            <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
              <path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"/>
            </svg>
          </a>
          <a href="https://instagram.com" target="_blank" rel="noopener noreferrer" className="text-gray-600 dark:text-gray-300 hover:text-pink-500 dark:hover:text-pink-400 transition-colors duration-200">
            <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
          ...
          <a href="https://github.com/Orka-kun" target="_blank" rel="noopener noreferrer" className="text-gray-600 dark:text-gray-300 hover:text-gray-800 dark:hover:text-gray-100 transition-colors duration-200">
            <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
